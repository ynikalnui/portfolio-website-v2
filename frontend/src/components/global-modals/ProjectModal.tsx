        ...
        >
          ...
          >
            ...
            <div className="flex flex-col text-center gap-y-2 md:gap-y-4">
              <p className="font-bold tracking-widest text-2xl md:text-3xl lg:text-4xl">
                Swapy
              </p>
              <p className="font-normal tracking-widest text-lg md:text-xl lg:text-2xl">
                MAY 2021 - MAY 2021
              </p>
            </div>
            ...
            <div className="flex w-full gap-x-4 justify-around">
              <button
                className="bg-black w-1/2 md:w-1/3 text-white p-4 section-text-lg 
              ...
              <button
                className="border-2 border-black w-1/2 md:w-1/3 text-black section-text-lg transition-colors
